package com.brutus.abio.views.adminpromocodes;
...
@Route(value = "admin/promo-codes/:promoCodeID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdminpromoCodesView extends Div implements BeforeEnterObserver {

    private final String PROMOCODE_ID = "promoCodeID";
    private final String PROMOCODE_EDIT_ROUTE_TEMPLATE = "admin/promo-codes/%s/edit";
    ...
    public AdminpromoCodesView(PromoCodeService promoCodeService) {
        this.promoCodeService = promoCodeService;
        addClassNames("adminpromo-codes-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AdminpromoCodesView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (promoCodeId.isPresent()) {
            ...
            if (promoCodeFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AdminpromoCodesView.class);
            }
        }
    }
