package com.brutus.abio.views.admindeliveryregions;
...
@PageTitle("Admin/delivery Regions")
@Route(value = "admin/delivery-regions/:deliveryRegionID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class AdmindeliveryRegionsView extends Div implements BeforeEnterObserver {

    private final String DELIVERYREGION_ID = "deliveryRegionID";
    private final String DELIVERYREGION_EDIT_ROUTE_TEMPLATE = "admin/delivery-regions/%s/edit";
    ...
    public AdmindeliveryRegionsView(DeliveryRegionService deliveryRegionService) {
        this.deliveryRegionService = deliveryRegionService;
        addClassNames("admindelivery-regions-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AdmindeliveryRegionsView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (deliveryRegionId.isPresent()) {
            ...
            if (deliveryRegionFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AdmindeliveryRegionsView.class);
            }
        }
    }
